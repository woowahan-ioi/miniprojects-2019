...
public class UserServiceTest extends TestUtil {
    ...
    @BeforeEach
    void setUp() {
        updateTestUploadFile = new MockMultipartFile(PROFILE_IMAGE_URL, UPDATE_PROFILE_IMAGE_FILE_NAME, IMAGE_CONTENT_TYPE, CONTENTS.getBytes(StandardCharsets.UTF_8));
    }
