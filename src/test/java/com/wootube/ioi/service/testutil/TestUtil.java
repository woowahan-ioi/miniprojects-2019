...
public class TestUtil {
    ...
    protected static final String UPDATED_VIDEO_FILE_NAME = "changeTestVideo.mp4";
    protected static final String UPDATED_THUMBNAIL_FILE_NAME = "changeTestVideoThumbnail.png";
